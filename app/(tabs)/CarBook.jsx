...
//   const { carType, acType } = route.params.bookingData || {};  // Get carType and acType from route params
//   const totalSeats = carType ? `${carType}${acType ? ` (${acType})` : ''}` : '';
  const { carType, acType } = route.params.bookingData || {};  
  const totalSeats = carType.includes('(') ? carType : `${carType}${acType ? ` (${acType})` : ''}`;
  useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity onPress={() => navigation.navigate('CarPage')} style={styles.backButtonContainer}>
...
/>
        ...
        <Text style={styles.text}>Date</Text>
                ...
                style={[ styles.inputWithIcon, styles.nonEditableInput]}
            >
